  ...
  return (
    <div className="agreement-page">
      ...
      <div className="agreement-content">
        ...
        <h3>一、总则</h3>
        <p>欢迎使用 Chat Capsule 软件。请在使用本软件前仔细阅读本协议。一旦你开始使用本软件，即表示你已充分理解并同意本协议的全部内容。</p>

        <h3>二、软件说明</h3>
        <p>Chat Capsule 是一款本地化的聊天记录查看与分析工具，所有数据处理均在用户本地设备上完成。</p>
        ...
        <h3>三、网络请求</h3>
        <p>本软件不包含联网更新检测，不会向外部服务器发送任何用户数据。</p>
