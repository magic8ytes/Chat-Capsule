...
import { windowControl } from '../services/ipc'
import './VideoWindow.scss'

export default function VideoWindow() {
    const [searchParams] = useSearchParams()
    const videoPath = toSafeMediaUrl(searchParams.get('videoPath'))
    ...
    useEffect(() => {
        const handleKeyDown = (e: KeyboardEvent) => {
            if (e.key === 'Escape') windowControl.close()
            if (e.key === ' ') {
                e.preventDefault()
                togglePlay()
            }
                ...
                <video
                    ...
                    onLoadedMetadata={(e) => {
                        ...
                        if (video.videoWidth && video.videoHeight) {
                            windowControl.resizeToFitVideo(video.videoWidth, video.videoHeight)
                        }
                    }}
